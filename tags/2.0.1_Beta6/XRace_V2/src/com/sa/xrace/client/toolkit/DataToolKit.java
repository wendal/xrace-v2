...
public final class DataToolKit {
    ...
    public static final float NORMAL_DISTANCE = 450.0f; // distance between the
                                                        // car and camera when
                                                        // car's stop
    public static final float NEAR_DISTANCE = 400.0f; // near distance between
                                                      // the car and camera when
                                                      // car's moving forward
    public static final float FAR_DISTANCE = 530.0f; // far distance between the
                                                     // car and camera when
                                                     // car's moving backward
    public static final float DISTANCE_PER_FRAME = 10.0f; // distance changed in
                                                          // one frame
